...
class AllTests {
    ...
    public void testReadURL() throws IOException {
        URLReader mockUrlReader = Mockito.mock(URLReader.class);

        Stream<String> mockedStream = Stream.of(
            "93.180.71.3 - - [17/May/2015:08:05:32 +0000] \"GET /downloads/product_1 HTTP/1.1\" 304 0 \"-\" \"Debian APT-HTTP/1.3 (0.8.16~exp12ubuntu10.21)\""
        );
        Mockito.when(mockUrlReader.read(anyString())).thenReturn(mockedStream);

        Stream<String> stream = mockUrlReader.read("mocked_url");
